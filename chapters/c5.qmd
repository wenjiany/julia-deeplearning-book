...
## should we redefine loss function?
...
best_lr, lr_losses, lr_plot = lr_finder(Flux.params(model), pets_dl, Adam(0.001), lr_range; reset_method=orig_params)
lr_plot
best_lr
...
reset_params!(Flux.params(model), orig_params);
