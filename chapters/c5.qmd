...
function DataLoader(bl::DataBlock; batchsize=256, shuffle=true, tfms::Augmentor.ImageOperation=Resize(224))
...
train_set = DataLoader(train_db; batchsize=256, shuffle=true, tfms=Resize(224, 224))
